...
Create a refactor RFC as a GitHub issue using `gh issue create`. Do NOT ask the user to review before creating -- just create it and share the URL. Use the RFC template below.
